    ...
    <View style={containerStyle}>
      ...
      <View style={{marginVertical: 10}}>
        ...
        <View
          ...
          <Text style={subHeaderTextStyle}>Sub Total</Text>
          <Text
            style={subHeaderTextStyle}>{`${SYMBOL.CURRENCY} ${subTotal}`}</Text>
        </View>
        <View
          style={{
            flexDirection: 'row',
          ...
          <Text style={subHeaderTextStyle}>Delivery Charges</Text>
          <Text
            style={
              subHeaderTextStyle
            }>{`${SYMBOL.CURRENCY} ${deliveryCharge}`}</Text>
        </View>
      </View>
      ...
      <View
        ...
        <Text style={headerTextStyle}>Total Amount Payable</Text>
        <Text style={totalTextStyle}>{`${SYMBOL.CURRENCY} ${netTotal}`}</Text>
      </View>
      {cartDiscount > 0 ? (
        <Text
          style={
